...
const SolutionListCard = ({ detail }) => {
  return (
    <div className="flex items-start w-full cursor-pointer mb-4">
      <div className="shadow-md mt-1 rounded-full overflow-hidden flex justify-center items-center w-6 h-6">
        <div
          className="w-full h-full bg-cover bg-center"
          style={{
            backgroundImage: `url(${detail.profile_picture ? detail.profile_picture : "/default_profile_picture.jpeg"})`,
          }}
        ></div>
      </div>
