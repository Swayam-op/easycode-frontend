...
<footer className="bg-dark-3 w-full rounded-lg shadow">
    ...
    <span className="block sm:text-sm text-xs text-gray-500 sm:text-center ">© 2024 <a rel="noreferrer" target='_blank' href="https://swayam-op.web.app" className="hover:underline">Swayam_Op™</a>. All Rights Reserved.</span>
    </div>
</footer>
