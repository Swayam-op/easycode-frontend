...
const Signin = () => {
  ...
  return (
    ...
    <div className="relative z-0 w-full mb-6 group">
      ...
      <label for="usernameOrEmail" className="peer-focus:font-medium absolute text-sm text-light-2  duration-300 transform -translate-y-7 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-dark-2 peer-focus:dark:text-light-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-7">Username or Email</label>
  </div>
  <div className="relative z-0 w-full mb-6 group">
  ...
  <div className='flex justify-between text-light-2 -tracking-tight text-sm mb-8'> <button className='block hover:text-black'>Forgot Password?</button> <Link to="/signup" className="block font-medium text-dark-2">Sign Up</Link></div>
  <div className='text-light-2 text-center font-normal -tracking-tight text-sm'>This site is protected by reCAPTCHA and the Google <u>Privacy Policy</u> and <u>Terms of Service apply</u>.</div>
