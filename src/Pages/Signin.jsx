...
const Signin = () => {
  return (
    ...
    <div className="relative z-0 w-full mb-6 group">
      <input type="text" name="usernameOrEmail" id="usernameOrEmail" className="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-light-2 appearance-none  focus:outline-none focus:ring-0 focus:border-dark-2 peer" placeholder=" " required />
  ...
  <button type="submit" className="text-white mb-7 bg-dark-2 hover:bg-black focus:ring-4 focus:outline-none focus:ring-light-2 font-medium rounded-md text-sm w-full px-5 py-2.5 text-center">Sign In</button>
